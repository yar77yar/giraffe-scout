...
type Props = {
  startTrip: (tariffId: number) => void;
};

export default function TariffModal({ startTrip }: Props) {
  const { selectedTariff, setSelectedTariff } = useTripProcessStore();
  ...
  return (
    ...
    >
      <Button title="X" onPress={() => setSelectedTariff(null)} />
            ...
            <View style={gStyles.ptrTariffBox}>
              <View
                style={{
                  ...
                  backgroundColor: selectedTariff?.colorHex
                    ? selectedTariff.colorHex
                    : "#EC1D68",
                }}
              >
                <Text style={gStyles.ptrTariffTxt}>{selectedTariff?.name}</Text>
              </View>
              ...
              <View style={gStyles.ptrTariffInfoCard}>
                <View style={gStyles.ptrTariffInfoStroke}>
                  ...
                  <Text style={gStyles.ptrTariffInfoValue}>
                    {selectedTariff?.boardingCost} &#8381;
                  </Text>
                </View>
                ...
                <View style={gStyles.ptrTariffInfoStroke}>
                  ...
                  <Text style={gStyles.ptrTariffInfoValue}>
                    {selectedTariff?.minuteCost.toFixed(1)} &#8381;/мин
                  </Text>
                </View>
              </View>
            </View>
      ...
      <View style={[mzStyles.BtnBox, gStyles.downPos]}>
        <TouchableOpacity
          ...
          onPress={() => startTrip(selectedTariff ? selectedTariff.id : 0)}
        >
